...
namespace Ballistic {
	...
	int AssetPool::AddRtxMaterial(const std::string& name, const RtxMaterial& mat) {
	...
	RtxMaterial& AssetPool::GetRtxMaterial(const std::string& name) {
		return rtxMaterials[ materialLookup[name] ];
	}

	int AssetPool::AddRtxMesh(const std::string& name, const std::string& path) {    
	...
	RtxMesh& AssetPool::GetRtxMesh(const std::string& name) {
