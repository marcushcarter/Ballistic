...
void HBAOBlurPass::AddPass(RenderGraph& g, FrameGraph& fg)
{
    ...
    [&](RenderGraph& builder, PassData& data) {
        builder.ReadImage(fg.aoRaw, VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL, VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT, VK_ACCESS_2_SHADER_READ_BIT);

        data.dst = builder.CreateImage("HBAOBlurImage",
            {
